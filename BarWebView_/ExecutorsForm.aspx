<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExecutorsForm.aspx.cs" Inherits="BarWebView.FormPerformers" %>
...
<body>
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetList" TypeName="BarService.BDImplementation.ExecutorBD"></asp:ObjectDataSource>
