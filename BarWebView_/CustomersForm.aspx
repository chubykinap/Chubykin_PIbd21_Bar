<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomersForm.aspx.cs" Inherits="BarWebView.FormCustomers" %>
...
<body>
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetList" TypeName="BarService.BDImplementation.CustomerBD"></asp:ObjectDataSource>
