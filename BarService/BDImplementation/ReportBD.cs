...
namespace BarService.BDImplementation
{
    public class ReportBD : IReportService
    {
        ...
        public ReportBD(BarDBContext context)
        {
            this.context = context;
        }

        public void SaveCocktailPrice(ReportBindModel model)
        {
            ...
            try
            {
                ...
                var table = document.Tables.Add(rangeTable, Cocktails.Count, 2, ref missing, ref missing);
