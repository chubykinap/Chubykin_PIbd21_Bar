<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CocktailsForm.aspx.cs" Inherits="BarWebView.FormServices" %>
...
<body>
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetList" TypeName="BarService.BDImplementation.CocktailBD"></asp:ObjectDataSource>
